...
public class CursoService {
    ...
    public Page<DadosDetalhamentoCurso> findByCategoria(String categoria, Pageable pageable) {
        Page<Curso> cursosPage = repository.findAllByCategoriaIgnoreCase(categoria, pageable);
        return cursosPage.map(cursos -> new DadosDetalhamentoCurso(
                cursos.getId(), cursos.getNome(), cursos.getCategoria()));
    }
}